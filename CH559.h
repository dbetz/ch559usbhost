...
#define CDC_GET_LINE_CODING     0x20
#define CDC_SET_LINE_CODING     0x21
#endif
...
typedef struct _USB_CDC_LINE_CODING {         /* status of BulkOnly USB-FlashDisk */
    uint8_t lRate0;
    uint8_t lRate1;
    uint8_t lRate2;
    uint8_t lRate3;
...
typedef USB_CDC_LINE_CODING __xdata *PXUSB_CDC_LINE_CODING;
